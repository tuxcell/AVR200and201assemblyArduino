...
// ***** Code
#define mpy8u(result, multiplicand, multiplier) \
...
// ***** Code
#define mpy8s(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
...
// ***** Code
#define mpy16u(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
...
// ***** Code
#define mpy16s(result, multiplicand, multiplier) \
__asm__ __volatile__ ( \
"mpy16s:	clr	%D0 \n\t" /*clear result byte 3*/ \
...
// ***** Code
#define div8u(result, remainder, multiplicand, multiplier) \
__asm__ __volatile__ ( \
...
// ***** Code
#define div8s(result, remainder, multiplicand, multiplier) \
__asm__ __volatile__ ( \
...
// ***** Code
#define div16u(result, remainder, multiplicand, multiplier) \
__asm__ __volatile__ ( \
...
#define div16s(result, remainder, multiplicand, multiplier) \
asm volatile ( \
