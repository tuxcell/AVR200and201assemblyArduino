...
// *
// ******************************************************************************
uint16_t mul16x16_16(uint16_t multiplicand, uint16_t multiplier)
{
uint16_t result;
...
// *
// ******************************************************************************
uint32_t mul16x16_32(uint16_t multiplicand, uint16_t multiplier)
{
uint32_t result;
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
...
// *
// ******************************************************************************
uint32_t mul16x16_24(uint16_t multiplicand, uint16_t multiplier)
{
uint32_t result;
__asm__ __volatile__ ( \
"	mul		%B2, %B1 \n\t" /* ah * bh*/ \
...
// *
// ******************************************************************************
int32_t muls16x16_32(int16_t multiplicand, int16_t multiplier)
{
int32_t result;
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
...
// *
// ******************************************************************************
int32_t muls16x16_24(int16_t multiplicand, int16_t multiplier)
{
int32_t result;
__asm__ __volatile__ ( \
"	muls	%B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
...
// *
// ******************************************************************************
void mac16x16_24(int32_t *result, int16_t multiplicand, int16_t multiplier)
{
__asm__ __volatile__ ( \
"	muls	%B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
"	add	%C0, r0 \n\t" \
...
// *
// ******************************************************************************
void mac16x16_32(int32_t *result, int16_t multiplicand, int16_t multiplier)
{
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
"	muls	%B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
...
void mac16x16_32_method_B(int32_t *result, int16_t multiplicand, int16_t multiplier)
{
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
"	muls	%B2, %B1 \n\t" /* (signed)ah * (signed)bh*/ \
...
// *
// ******************************************************************************
int32_t fmuls16x16_32(int16_t multiplicand, int16_t multiplier)
{
int32_t result;
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
...
// *
// ******************************************************************************
void fmac16x16_32(int32_t *result, int16_t multiplicand, int16_t multiplier)
{
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
"	fmuls	%B2, %B1 \n\t" /* ( (signed)ah * (signed)bh ) << 1*/ \
...
void fmac16x16_32_method_B(int32_t *result, int16_t multiplicand, int16_t multiplier)
{
__asm__ __volatile__ ( \
"	clr	r2 \n\t" \
"	clr	r2 \n\t" \
